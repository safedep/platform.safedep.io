...
const Auth = () => {
  return (
    <main className="flex items-center justify-center min-h-screen px-4 py-8 bg-gradient-to-br from-blue-100 to-white font-inter">
      <MainCard className="flex w-full max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-6 lg:p-8 flex-1 flex flex-col items-center justify-center bg-gray-50 border-r border-gray-200">
        ...
        <div className="p-6 lg:p-8 flex-1 flex flex-col justify-center space-y-6">
          <div>
            <div className="flex items-center gap-2 mb-4">
                <h1 className="text-4xl lg:text-5xl font-light text-gray-900 text-left leading-tight">
                Get Started
                <br />
                <span className="inline-flex items-center">
                  With <Image src="/safedepsign.svg" alt="SafeDep Logo" width={20} height={20} className="w-20 h-8 object-contain ml-2" />
                </span>
              </h1>
            </div>
